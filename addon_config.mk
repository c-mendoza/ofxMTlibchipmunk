...
meta:
	ADDON_NAME = ofxMTlibchipmunk
	ADDON_DESCRIPTION = Packages Chipmunk2D physics library for simple inclusion into openFrameworks projects
	ADDON_AUTHOR = Cristobal Mendoza
	ADDON_TAGS = "Physics" "simulation"
	ADDON_URL = http://github.com/c-mendoza/ofxMTlibchipmunk
...
common:
	...
	ADDON_INCLUDES = libs/libchipmunk/include
...
linux64:
	...
	ADDON_LIBS =
	ADDON_LIBS += libs/libchipmunk/lib/linux64/libchipmunk.a
# vs:
...
osx:
	...
	# ADDON_FRAMEWORKS =
	ADDON_LIBS =
	ADDON_LIBS += libs/libchipmunk/lib/osx/libChipmunk-Mac.a
